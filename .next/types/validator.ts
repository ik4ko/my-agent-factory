...
// Validate ../../src/app/api/hermes/command/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/hermes/command">> = Specific
  const handler = {} as typeof import("../../src/app/api/hermes/command/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
