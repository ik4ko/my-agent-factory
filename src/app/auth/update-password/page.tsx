        ...
        <Card className="max-w-md w-full rounded-[3.5rem] shadow-2xl p-10 border border-white/10 bg-white/5 backdrop-blur-2xl animate-in zoom-in-95 duration-500">
          <div className="space-y-8">
            <div className="text-center space-y-2">
              ...
              <h2 className="text-3xl font-black uppercase tracking-tighter text-white">New Password</h2>
              <p className="text-[10px] font-black uppercase tracking-widest text-white/60">
                Set your new agency password
              </p>
            </div>
            ...
            {done ? (
              <div className="flex flex-col items-center gap-4 py-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-white/50 text-[11px] font-medium mt-1">Redirecting to dashboard...</p>
                </div>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest ml-2 text-white/70">New Password</Label>
